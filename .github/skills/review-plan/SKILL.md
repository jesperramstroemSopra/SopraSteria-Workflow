...
1. **Plan artifact** — read from `.goals/workflow/create-plan/` for the latest plan. If the user specifies a file, use that.
...
Save to: `.goals/workflow/review-plan/review-{timestamp}.md`
