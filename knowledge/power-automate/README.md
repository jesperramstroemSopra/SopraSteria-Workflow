...
| [`patterns/expressions.md`](patterns/expressions.md) | WDL, Filter array/Select instead of lambdas, null/types, OData and scope |
| [`../power-fx/hosts.md`](../power-fx/hosts.md) | Desktop Power Fx and new workflow-designer boundaries; not cloud-flow expression parity |
...
- [`../solutions/patterns/alm-pipeline.md`](../solutions/patterns/alm-pipeline.md) — CI/CD for solution deployment
